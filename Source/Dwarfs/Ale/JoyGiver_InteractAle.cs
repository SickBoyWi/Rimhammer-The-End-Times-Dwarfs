...
{
    public class JoyGiver_InteractAle : JoyGiver
    {
        ...
        {
            JoyGiver_InteractAle.tmpCandidates.Clear();
            this.GetSearchSet(pawn, JoyGiver_InteractAle.tmpCandidates);
            if (JoyGiver_InteractAle.tmpCandidates.Count == 0)
            {
                return null;
            }
            ...
            Map map = pawn.Map;
            List<Thing> searchSet = JoyGiver_InteractAle.tmpCandidates;
