...
namespace TheEndTimes_Dwarfs
{
    public class Building_WallLight : Building
    {
        ...
        private TheEndTimes_Dwarfs.WallLightGlower wallGlower;
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            StaticWallLightStuff.lastRoom = null;
        ...
        private void SpawnGlower()
        {
            ...
            this.wallGlower = (TheEndTimes_Dwarfs.WallLightGlower)this.glower;
        ...
        {
            this.defStr = "RH_TET_Dwarfs_WallLightGlower";
            this.moteStr = "RH_TET_Dwarfs_WallLight_On";
