...
{
    public class JobDriver_TakeAleOutOfBugmansFermentingBarrel : JobDriver
    {
        ...
        protected Building_BugmansFermentingAleBarrel AleBarrel =>
            (Building_BugmansFermentingAleBarrel)job.GetTarget(BarrelInd).Thing;
