...
{
    public abstract class JoyGiver_InteractBugmansAle : JoyGiver
    {
        ...
        {
            JoyGiver_InteractBugmansAle.tmpCandidates.Clear();
            this.GetSearchSet(pawn, JoyGiver_InteractBugmansAle.tmpCandidates);
            if (JoyGiver_InteractBugmansAle.tmpCandidates.Count == 0)
            {
                return null;
            }
            ...
            Map map = pawn.Map;
            List<Thing> searchSet = JoyGiver_InteractBugmansAle.tmpCandidates;
