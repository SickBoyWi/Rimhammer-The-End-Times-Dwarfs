...
{
    public class JobDriver_FillBugmansFermentingBarrel : JobDriver
    {
        private const TargetIndex BarrelInd = TargetIndex.A;
        private const TargetIndex WortInd = TargetIndex.B;
        private const int Duration = 200;

        protected Building_BugmansFermentingAleBarrel Barrel => (Building_BugmansFermentingAleBarrel)this.job.GetTarget(BarrelInd).Thing;
